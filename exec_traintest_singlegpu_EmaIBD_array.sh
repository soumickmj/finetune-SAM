...
dsTag="EmaIBDTilesV0"
targets="Lamina_propria,Crypt,Muscle,Surface,Granuloma,Granulation_tissue,Lymphoid_follicle_or_aggregates,Submucosa"
batch_size="3"
num_workers="3"
dsRoot="/group/glastonbury/yolo_ibd_substructures"
out_type="ftSAM_all"  # Name of the segmentation folder, as well as checkpoint folder 
