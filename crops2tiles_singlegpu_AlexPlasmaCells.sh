...
additional_infer_img_list="${additional_infer_img_list:-/group/glastonbury/alex/yolov8_workspace/SAM_FT/CSVs/Tiles/Small/test.csv}"
test_tag="${test_tag:-Crops2Tiles_testSmall_lowres96}"
